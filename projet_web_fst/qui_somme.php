  ...
  <main>
    ...
    <div class="container">
      ...
      <div class="plan2">
        ...
        <img class="img" src="img/moi.JPG" alt="moi">
        <table>
          <tbody>
            <tr>
              <td class="td">Nom :</td>
            ...
            <tr>
              ...
              <td><a href="mailto: abdellah.boualam@usmba.ac.ma">abdellah.boualam@usmba.ac.ma</a></td>
            </tr>
         </tbody>
        </table>
        
      </div>
      <a href="accueil.php" class="btn_fermer frp2">&times;</a>
