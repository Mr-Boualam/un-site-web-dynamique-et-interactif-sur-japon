    ...
    <div class="container">
      ...
      <div class="plan">
        ...
        <div class="etablissement">
          <a href="https://www.iwate-u.ac.jp/english/index.html" class="etablissement-lien">
            <img src="img/logo1.jpg" class="etablissement-logo">
            <h2 class="etablissement-titre"> Université d’Iwate</h2>
          </a>
        </div>
  
        <div class="etablissement">
          <a href="https://muroran-it.ac.jp/en/" class="etablissement-lien">
            <img src="img/mit_logo2.png" class="etablissement-logo">
            <h2 class="etablissement-titre">Institut de technologie de Muroran,</h2>
          </a>
        </div>
  
        <div class="etablissement">
          <a href="https://www.tohoku.ac.jp/en/" class="etablissement-lien">
            <img src="https://www.tohoku.ac.jp/en/common_images/header_logo.png" class="etablissement-logo">
            <h2 class="etablissement-titre">Université du Tōhoku,</h2>
          </a>
        </div>
