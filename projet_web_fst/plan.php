    ...
    <div class="container">
      ...
      <div class="plan">
        ...
        <table >
          <tbody>
            <tr>
              <td class="td">Accueil:</td>
              <td> renvoie sur la page index du site</td>
            </tr>
            <tr>
              <td class="td">Plan de site :</td>
              <td> est pour afficher au centre de la page le plan du site : différents menus</td>
            </tr>
            <tr>
              <td class="td">Qui sommes-nous:</td>
              <td>afficher des informations personnelles sur le binôme qui a préparé le mini-projet.</td>
            </tr>
            <tr>
              <td class="td">Sites et Monuments:</td>
              <td>s’affiche pour chaque monument une photo avec une brève description</td>
            </tr>
            <tr>
              <td class="td"> Index des villes:</td>
              <td>s’affiche un tableau qui recense 3 villes au maximum avec leurs Nom, Superficie et Population et des Photos de la ville</td>
            </tr>
            <tr>
              <td class="td">Google map:</td>
              <td> s’affiche la carte googleMap qui va permettre à l’internaute de localiser facilement ce pays sans partir sur un autre site</td>
            </tr>
            <tr>
              <td class="td">Liens utiles:</td>
              <td>s’affiche les liens vers des établissements publics du pays .</td>
            </tr>
          </tbody>
        </table>
      </div>
      <a href="accueil.php" class="btn_fermer">&times;</a>
